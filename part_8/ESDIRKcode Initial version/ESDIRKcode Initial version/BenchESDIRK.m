...
[Tout,Xout,Gout,info,stats] = ESDIRK(fun,jac,t0,tfinal,x0,h0,absTol,relTol,method,mu);
t = Tout;
x = Xout;
...
% plot([min(t) max(t)], [1 1], '-k') % steps above this line is failed steps that converged
% xlabel('t_n')
% ylabel('r_n/tol')
