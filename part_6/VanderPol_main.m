...
print(gcf,'6_4_adaptive_mu_1_5','-dpdf','-r0')

infos_csv = [tols;infos];
csvwrite('6_4_adaptive_mu_1_5.csv',infos_csv,0,1);
...
pos = get(gcf,'Position');
set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(gcf,'6_4_adaptive_mu_15','-dpdf','-r0')

infos_csv = [tols;infos];
csvwrite('6_4_adaptive_mu_15.csv',infos_csv,0,1);
