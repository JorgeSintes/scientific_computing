...
for tol=tols
    tols_legend = [tols_legend, 'Impl. Euler, tol = ' + string(tol), 'ode45, tol = ' + string(tol)];
end
...
for tol=tols
    ...
    sol_3D_45 = ode45(@(t,x) VanderPol(t,x,mu),tspan, x0, opts);
    T_45 = sol_3D_45.x;
    X_45 = sol_3D_45.y;
...
print(gcf,'3_6_mu_1_5','-dpdf','-r0')

infos_csv = [tols;infos];
infos_45_csv = [tols;infos_45];
csvwrite('3_6_mu_1_5.csv',infos_csv,0,1);
csvwrite('3_6_mu_1_5_ode45.csv',infos_45_csv,0,1);
...
for tol=tols
    tols_legend = [tols_legend, 'Impl. Euler, tol = ' + string(tol), 'ode15s, tol = ' + string(tol)];
end
...
for tol=tols
    ...
    opts = odeset('RelTol',tol,'AbsTol',tol,'InitialStep',h0);
    sol_15 = ode15s(@(t,x) VanderPol(t,x,mu),tspan, x0, opts);
    T_15 = sol_15.x;
    X_15 = sol_15.y;
...
pos = get(gcf,'Position');
set(gcf,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(gcf,'3_6_mu_15','-dpdf','-r0')

infos_csv = [tols;infos];
infos_15_csv = [tols;infos_15];
csvwrite('3_6_mu_15.csv',infos_csv,0,1);
csvwrite('3_6_mu_15_ode15s.csv',infos_15_csv,0,1);
...
for tol=tols
    tols_legend = [tols_legend, 'Imp. Euler, tol = ' + string(tol), 'ode45, tol = ' + string(tol), 'ode15s, tol = ' + string(tol)];
end
...
for tol=tols
    ...
    for i=1:size(Fs,2)
        ...
        opts = odeset('RelTol',tol,'AbsTol',tol,'InitialStep',h0);
        sol_3D_45 = ode45(@(t,x) CSTR_3D_fJ(t,x,F,params),tspan, x0_45, opts);
        ...
        sol_3D_15 = ode15s(@(t,x) CSTR_3D_fJ(t,x,F,params),tspan, x0_15, opts);
    ...
    for i=1:size(Fs,2)
        ...
        params = [beta,k0,EaR,CAin,CBin,Tin,V];
        args = {F, [beta,k0,EaR,CAin,CBin,Tin,V]};
        [T_local,X_local,r_local,h_local, info_local] = EulerExplicit_adaptive(@CSTR_1D_fJ,tspan,h0,x0,abstol,reltol,args);
        ...
        opts = odeset('RelTol',tol,'AbsTol',tol,'InitialStep',h0);
        sol_1D_45 = ode45(@(t,x) CSTR_1D_fJ(t,x,F,params),tspan, x0_45, opts);
        ...
        sol_1D_15 = ode15s(@(t,x) CSTR_1D_fJ(t,x,F,params),tspan, x0_15, opts);
    ...
    csvwrite('3_6_3D.csv',infos_3D_csv,0,1);
    csvwrite('3_6_3D_45.csv',infos_3D_45_csv,0,1);
    csvwrite('3_6_3D_15.csv',infos_3D_15_csv,0,1);
    
    infos_1D_csv = [tols;infos_1D];
    infos_1D_45_csv = [tols;infos_1D_45];
    infos_1D_15_csv = [tols;infos_1D_15];
    csvwrite('3_6_1D.csv',infos_1D_csv,0,1);
    csvwrite('3_6_1D_45.csv',infos_1D_45_csv,0,1);
    csvwrite('3_6_1D_15.csv',infos_1D_15_csv,0,1);
    end
