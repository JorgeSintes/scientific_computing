function [T_out,X_out,X_real,e_l,e_g,e_out,r_out,h_out,info] = ... 
    DOPRI54TE_adaptive(fun,anal_sol,tspan,h0,x0,abstol,reltol,butcher,args)
...
while t < tf
    ...
    while ~AcceptStep
        ...
        if AcceptStep
            ...
            e_l = [e_l, abs(x - feval(anal_sol, t, X_out(:,end), T_out(end), args{:}))];
